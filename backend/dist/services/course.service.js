...
const gpaCalculator_1 = require("../utils/gpaCalculator"); // Import the GPA calculator
exports.CourseService = {
    ...
    createCourse(userId, data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (status !== client_1.CourseStatus.COMPLETED &&
                grade !== undefined &&
                grade !== null) {
            ...
            const finalGrade = status === client_1.CourseStatus.COMPLETED ? grade : null;
            if (finalGrade !== null && finalGrade !== undefined) {
                gpaScore = (0, gpaCalculator_1.calculateGpaScore)(finalGrade);
            }
     ...
     */
    getCoursesByUser(userId, filters) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     */
    updateCourse(userId, courseId, data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const updateData = {}; // Use Prisma's update type
            ...
            if (data.categoryId !== undefined) {
                ...
                const newCategory = yield db_1.default.courseCategory.findUnique({
            ...
            if (data.status !== undefined) {
                if (!Object.values(client_1.CourseStatus).includes(data.status)) {
                    throw new Error("Invalid course status.");
                }
            ...
            if (newStatus !== client_1.CourseStatus.COMPLETED && newGrade !== null) {
            ...
            if (needsGpaRecalc) {
                if (newStatus === client_1.CourseStatus.COMPLETED && newGrade !== null) {
                    ...
                    updateData.gpaScore = (0, gpaCalculator_1.calculateGpaScore)(newGrade);
                ...
                if (existingCourse.status === client_1.CourseStatus.COMPLETED &&
                    gradeToUpdate !== null) {
                    if (typeof gradeToUpdate !== "number" ||
                        isNaN(gradeToUpdate) ||
                        gradeToUpdate < 0 ||
                        gradeToUpdate > 100) {
                    ...
                    updateData.gpaScore = (0, gpaCalculator_1.calculateGpaScore)(gradeToUpdate);
                }
                else if (existingCourse.status === client_1.CourseStatus.COMPLETED &&
                    gradeToUpdate === null) {
    ...
    deleteCourse(userId, courseId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const courseToDelete = yield db_1.default.course.findUnique({
                where: { id: courseId },
            });
            if (!courseToDelete) {
                throw new Error(`Course with ID ${courseId} not found.`);
